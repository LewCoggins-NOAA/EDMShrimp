...
source("C:\\Users\\lewis.coggins\\Documents\\GitHub\\EDMShrimp\\SimplexSmapFuncs.R")
...
#----- Model time series -----#
d <- read.csv("C:\\Users\\lewis.coggins\\Documents\\GitHub\\EDMShrimp\\TwoSppUni_Example.csv")
tl <- nrow(d)
time <- d$ï..t
